...
export const AppFooter = () => (
  <footer className="text-center text-xs text-gray-400 py-6 border-t border-gray-100 px-4">
    <p className="mb-2">
    ...
    <p>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center ml-1.5 text-gray-400 hover:text-blue-600 align-middle"
      >
